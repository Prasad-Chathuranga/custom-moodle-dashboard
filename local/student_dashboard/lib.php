...
/**
 * Callback to intercept my/index.php for students
 * This function is called before HTTP headers are sent
 */
function local_student_dashboard_before_http_headers() {
    ...
    if ($isstudent) {
        ...
        ob_start();
        register_shutdown_function('local_student_dashboard_replace_content');
    }
}

/**
 * Replace the dashboard content with our custom version
 */
function local_student_dashboard_replace_content() {
    ...
    // Get and clear the buffered content
    if (ob_get_level()) {
        $content = ob_get_contents();
        ob_clean();
        
        // Generate our custom dashboard
        echo local_student_dashboard_generate_content();
    }
}

/**
 * Generate the custom student dashboard content
 */
function local_student_dashboard_generate_content() {
